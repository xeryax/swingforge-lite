...
Section ""
    ...
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ar" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "bg" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ca" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "cs" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "da" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "de" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "el" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "es" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "fa" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "fi" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "fr" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "hr" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "id" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "it" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ja" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ko" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "lt" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "mk" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ms" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "nl" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "no" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "pl" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "pt" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ro" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "ru" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "sr-Cyrl-RS" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "sr-Latn-RS" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "sv" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "th" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "tr" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "zh-CHS" "dll"
    !insertmacro CopyDirectoryContent "${BUILDDIR}" "$INSTDIR\Languages" "zh-Hant" "dll"
...
!ifndef PORTABLE
    ...
    Section "Uninstall"
        ...
        Delete "$INSTDIR\*.*"
        !insertmacro RemoveDirectory "$INSTDIR\Languages"
